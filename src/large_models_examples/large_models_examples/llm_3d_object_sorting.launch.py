...
from launch.actions import IncludeLaunchDescription, GroupAction, DeclareLaunchArgument, OpaqueFunction, TimerAction
...
def launch_setup(context):
    ...
    return [mode_arg,
            ...
            large_models_launch,     # 按时间间隔启动
            llm_3d_object_sorting_node,          # 启动后延迟的部分
            ]
